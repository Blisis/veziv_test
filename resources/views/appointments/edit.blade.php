                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('appointments.update', $appointment->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control selectDate" name="date" value="{{ $appointment->date }}">
                                @error('date')
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control avaiableHours" name="hour" id="">
                                    <option value="{{ $appointment->hour }}">{{ $appointment->hour }}</option>
                                </select>
                                @error('hour')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
